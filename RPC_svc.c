...
{
	union {
		parameters corrected_questionnaire_100_arg;
	} argument;
	char *result;
	...
	case Corrected_questionnaire:
		_xdr_argument = (xdrproc_t) xdr_parameters;
		_xdr_result = (xdrproc_t) xdr_results;
		local = (char *(*)(char *, struct svc_req *)) corrected_questionnaire_100_svc;
		break;

	case Statistics:
		_xdr_argument = (xdrproc_t) xdr_void;
		_xdr_result = (xdrproc_t) xdr_results;
		local = (char *(*)(char *, struct svc_req *)) statistics_100_svc;
		break;
